    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('assets/img/bg-login8.jpg');">
                            ...
                            <div class="content content-full">
                                ...
                                <form class="js-validation-signin px-30" action="<?php echo base_url().'clogin/verification'?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="text" class="form-control" id="login-username" name="email" value="admin" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="password" class="form-control" id="login-password" value="admin" name="mdp" required>
