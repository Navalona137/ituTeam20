			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-6 text-center menu-1">
					<ul>
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								<li><a href="<?php echo base_url('cobjet/administration'); ?>">Item List</a></li>
							</ul>
						</li>
						<li><a href="<?php echo base_url('cobjet/exchangeList'); ?>">Exchange</a></li>
                        <li><a href="<?php echo base_url('cobjet/requestList'); ?>">Request</a></li>
                        <li><a href="<?php echo base_url('cobjet/historique'); ?>">Historical</a></li>
						<li><a href="#">Contact</a></li>
                        <li class="has-dropdown">
							<a href="services.html">Setting</a>
							<ul class="dropdown nav-menu">
								<li><a href="">Administration</a></li>
								<li><a href="<?php echo base_url('cpersonne'); ?>">Create User</a></li>
				...
				<div class="col-md-3 col-xs-4 text-right hidden-xs menu-2">
					<ul>
						...
						<li class="shopping-cart"><a href="#" class="cart"><span></span></a></li>
					</ul>
				</div>
			</div>
