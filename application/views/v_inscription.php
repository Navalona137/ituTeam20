    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('assets/img/bg-login6.jpg');">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="<?php echo base_url();?>">
                                        <i class=""></i>
                                        <span class="font-size-xl text-success">SWITCH</span>
                                    </a> 
                                ...
                                <form class="js-validation-signin px-30" action="<?php echo base_url().'cpersonne/insertion'?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="radio" value="M" name="sexe" id="homme" checked="checked">
                                                <span style="padding-left: 5px;font-weight: normal;"> Masculin </span> 
                                                <input type="radio" value="F" name="sexe" id="femme" style="margin-left: 60px;">
